...
<body>
    ...
    <div class="container">
        <div class="section__title section__title_about-us" data-aos="fade-down" data-aos-duration="1500">Немного о нас</div>
        <div class="about-us__inner">
            <img src="./assets/pictures/about-us.png" class="about-us__picture" alt="" data-aos="zoom-in" data-aos-duration="1000">
            <div class="about-us__content">
                <div class="content__item" data-aos="fade-right" data-aos-duration="800" data-aos-delay="0">
                    <input type="checkbox" class="content__input" id="content__1">
                    <label for='content__1' class="content__title">Enactus Taraz</label>
                    <div class="content__text">Комманда учеников НИШ города Тараз Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam quae aliquid incidunt eaque amet reiciendis, accusamus tempore quam.</div>
                </div>
                <div class="content__item" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200">
                    <input type="checkbox" class="content__input" id="content__2">
                    <label for='content__2' class="content__title">Наша миссия</label>
                    <div class="content__text">Комманда учеников НИШ города Тараз Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam quae aliquid incidunt eaque amet reiciendis, accusamus tempore quam.</div>
                </div>
                <div class="content__item" data-aos="fade-right" data-aos-duration="800" data-aos-delay="400">
                    <input type="checkbox" class="content__input" id="content__3">
                    <label for='content__3' class="content__title">Наша цель</label>
                    <div class="content__text">Комманда учеников НИШ города Тараз Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam quae aliquid incidunt eaque amet reiciendis, accusamus tempore quam.</div>
                </div>
            </div>
        </div>
        ...
        <div class="blog--container">
            ...
            <?php (int)$k=0; foreach($articles as $a): ?>
                <div class="article" data-aos="slide-up" data-aos-duration="500" data-aos-offset="<?=$k?>">
                    ...
                    <p class="article--text"><?=articles_intro($a['text'])?> ...</p>
    ...
    <section class="team" id="team">
        <div class="section__title" data-aos="fade-down" data-aos-duration="1500">Наша команда</div>
